...
* feat: crossplane-kubernetes-provider Crossplane provider stack (by @patrickleet)

  Kubernetes provider, ProviderConfig, and RBAC.
...
* refactor: rename to KubernetesProviderStack on crossplane.ops.com.ai group (by @patrickleet)

  Renamed XRD kind to KubernetesProviderStack, API group to crossplane.ops.com.ai, and the
  repo/package to crossplane-kubernetes-provider-stack. No consumers yet; pre-release.
